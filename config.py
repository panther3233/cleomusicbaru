...
BOT_TOKEN = getenv("BOT_TOKEN", "6779144727:AAGwyE3CDjYT468-srYUZW1B0gcwjcjxMOM")

# Add Owner Username without @ 
OWNER_USERNAME = getenv("OWNER_USERNAME", "uneedsaha")
# Get Your bot username
BOT_USERNAME = getenv("BOT_USERNAME" , "clegynxrobot")
...
# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "1855778662").split())
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/panther3233/cleomusicbaru",
)
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/clegynstore")
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/cleoosupport")
