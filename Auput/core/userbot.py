...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("cleoosupport")
                await self.one.join_chat("clegynstore")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("cleoosupport")
                await self.two.join_chat("clegynstore")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("cleoosupport")
                await self.three.join_chat("clegynstore")
            except:
                pass
            assistants.append(3)
            try:
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("cleosupport")
                await self.four.join_chat("cleoosupport")
            except:
                pass
            assistants.append(4)
            try:
